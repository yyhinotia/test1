...
|---|---|---|---|---|
| UI | `ui.md` | 已验收 | `INC-UI-016` | 2026-09-25T19:38:41+08:00 |
| 战斗 | `combat.md` | 已验收 | `INC-COMBAT-008` | 2026-09-25T18:30:17+08:00 |
| Pawns | `pawns.md` | 已验收 | `INC-PAWNS-018` | 2026-09-25T19:38:41+08:00 |
...
| 存档 | `save.md` | 未创建 | - | - |
| 音频 | `audio.md` | 未创建 | - | - |
| 核心 | `core.md` | 开发中 | `INC-CORE-010` | 2026-09-25T19:22:00+08:00 |
| 工具 | `tools.md` | 已验收 | `INC-TOOLS-002` | 2026-09-25T13:54:46+08:00 |
| 测试 | `testing.md` | 开发中 | `INC-TESTING-009` | 2026-09-25T19:22:00+08:00 |
...
| `INC-CROSS-017` | `in_progress` | `INC-SECT-001`、`INC-SECT-002`、`INC-SECT-003`、`INC-PAWNS-018`、`INC-UI-016`、`INC-CORE-010`、`INC-TESTING-009` | 最小宗门（MVP-⑤）：把秘境灵石收益变成可升级的宗门设施，产出修为 / 灵草 / 丹药 / 功法 / 强化武器，形成「回去修炼 / 制作 / 强化，然后再次出发」的闭环 | 部分通过 | 部分已验收 | 2026-09-25T19:38:41+08:00 |
...
|---|---|---|---|---|---|---|---|---|
| `INC-CROSS-017` | - | cross | `in_progress` | 最小宗门：秘境收益 → 设施升级 → 修为 / 灵草 / 丹药 / 功法 / 强化 → 再战 | 2026-09-25T19:38:41+08:00 | 部分通过 | 部分已验收 | - |
...
| `INC-CORE-010` | `INC-CROSS-017` | core | `planned` | 主场景宗门接线与秘境收益入账 | 2026-09-25T19:22:00+08:00 | 未验证 | 未验收 | - |
| `INC-TESTING-009` | `INC-CROSS-017` | testing | `planned` | 宗门闭环证据：收益 → 修炼 / 制作 / 强化 → 再战 | 2026-09-25T19:22:00+08:00 | 未验证 | 未验收 | - |
