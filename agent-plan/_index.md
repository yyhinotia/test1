...
| 战斗 | `combat.md` | 已验收 | `INC-COMBAT-011` | 2026-09-26T02:24:14+08:00 |
...
| 世界 | `world.md` | 待验收 | `INC-WORLD-008` | 2026-09-26T01:56:11+08:00 |
...
| `INC-CROSS-021` | `in_progress` | `INC-COMBAT-010`、`INC-COMBAT-011`、`INC-COMBAT-012`、`INC-PAWNS-022`、`INC-PAWNS-023`、`INC-WORLD-008`、`INC-TESTING-019` | Skill × Enemy Interaction 验证：技能池 / 问题型敌人 / 问题房间 | 进行中（3/7 子项已验收：`INC-COMBAT-010` / `INC-PAWNS-022` / `INC-COMBAT-011`；`INC-COMBAT-012` / `INC-PAWNS-023` 待开发） | 待验收 | 2026-09-26T02:24:14+08:00 |
...
| `INC-CROSS-021` | - | cross | `in_progress` | Skill × Enemy Interaction 验证：技能池 / 问题型敌人 / 问题房间 | 2026-09-26T02:24:14+08:00 | 部分通过（3/7 子项已验证并验收：`INC-COMBAT-010` / `INC-PAWNS-022` / `INC-COMBAT-011`；`INC-COMBAT-012` / `INC-PAWNS-023` 待开发，其余 2 项待开发） | 进行中 | `develop` / `4c0061d`、`0f20ed2`、`f3537e2`、`1f222b6`、`5f5ffeb` |
...
| `INC-COMBAT-012` | `INC-CROSS-021` | combat | `planned` | 条件伤害（对受控目标额外倍率） | 2026-09-26T02:19:07+08:00 | 未验证 | 未验收 | 未开始 |
...
| `INC-PAWNS-023` | `INC-CROSS-021` | pawns | `planned` | 玩家技能池扩到 8 个（条件爆发 + 主动回复） | 2026-09-26T02:19:07+08:00 | 未验证 | 未验收 | 未开始 |
