...
> 最后修改：2026-09-25T14:09:53+08:00
> 规则来源：`../AGENTS.md`
...
|---|---|---|---|---|
| UI | `ui.md` | 已验收 | `INC-UI-002` | 2026-09-25T14:09:53+08:00 |
| 战斗 | `combat.md` | 已验收 | `INC-COMBAT-001` | 2026-09-25T13:44:10+08:00 |
| Pawns | `pawns.md` | 已验收 | `INC-PAWNS-002` | 2026-09-25T14:09:53+08:00 |
...
| `INC-UI-002` | `INC-CROSS-002` | ui | `accepted` | 血条按生命状态变化显示并延迟自动隐藏 | 2026-09-25T14:09:53+08:00 | 通过 | 已验收（2026-09-25T14:09:53+08:00） | main / 待 docs(plan) 提交回写 hash |
| `INC-PAWNS-002` | `INC-CROSS-002` | pawns | `accepted` | 生命状态变化统一入口与血条锚点结构 | 2026-09-25T14:09:53+08:00 | 通过 | 已验收（2026-09-25T14:09:53+08:00） | main / 待 docs(plan) 提交回写 hash |
| `INC-PAWNS-003` | - | pawns | `planned` | 抽取 HealthComponent | 2026-09-25T13:54:46+08:00 | 未验证 | 未验收 | - |
...
| `INC-CROSS-002` | cross（含 ui / pawns 子 Increment） | 2026-09-25T14:02:26+08:00 | 2026-09-25T14:09:53+08:00 | 待本次提交后回写 |
