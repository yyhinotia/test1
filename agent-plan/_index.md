...
> 最后修改：2026-09-25T13:54:46+08:00  
> 规则来源：`../AGENTS.md`
...
|---|---|---|---|---|
| UI | `ui.md` | 进行中 | `INC-UI-002` | 2026-09-25T13:54:46+08:00 |
| 战斗 | `combat.md` | 已验收 | `INC-COMBAT-001` | 2026-09-25T13:44:10+08:00 |
| Pawns | `pawns.md` | 进行中 | `INC-PAWNS-002` | 2026-09-25T13:54:46+08:00 |
...
| `INC-CROSS-002` | `in_progress` | `INC-UI-002`、`INC-PAWNS-002` | 血条按生命状态变化显示、2 秒无变化后隐藏 | 未验证 | 未验收 | 2026-09-25T13:54:46+08:00 |
...
- 验证结论：待子 Increment 验证通过后填写。
- 验收时间：待用户验收。
- 备注：验收通过前不提交到 `main`；本文档与 `docs/血条ui需求.txt` 属于计划输入，可与计划提交一起入库。
## 活跃 Increment
...
| `INC-UI-002` | `INC-CROSS-002` | ui | `in_progress` | 血条按生命状态变化显示并延迟自动隐藏 | 2026-09-25T13:54:46+08:00 | 未验证 | 未验收 | 待验收后提交 |
| `INC-PAWNS-002` | `INC-CROSS-002` | pawns | `in_progress` | 生命状态变化统一入口与血条锚点结构 | 2026-09-25T13:54:46+08:00 | 未验证 | 未验收 | 待验收后提交 |
